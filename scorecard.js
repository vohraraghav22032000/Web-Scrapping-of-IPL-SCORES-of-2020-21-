...
//const url = 'https://www.espncricinfo.com/serires/ipl-2020-21-1210595/mumbai-indians-vs-chennai-super-kings-1st-match-1216492/full-scorecard'
    ...
    for (let i = 0; i < innings.length; i++) {
      ...
      for(let j=0;j<allRows.length;j++){
          ...
          if(isWorthy==true)
          {
              ...
              processPlayer(
                  teamName , opponentName , playerName , runs , balls , fours , sixes , STR , 
                  venue , date , result
              )
          }
...
//changing json file into sheet  and expecting a json value
